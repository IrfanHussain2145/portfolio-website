...
const ContactForm = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_jrz0ohe', 'template_ny0yliq', form.current, {
            publicKey: 'uN0Rn1BnqlA1sz2FK',
          })
          .then(
            () => {
              setName('');
            ...
            (error) => {
              ...
              setSuccess('Error! Please try copying my email and contacting me traditionally.')
            },
          );
      };
  return (
    <div>
        ...
        <form className="flex flex-col gap-4 text-white" ref={form} onSubmit={sendEmail}>
            ...
            <textarea name='message' type="text" placeholder='Message' rows='7' cols='50' required 
