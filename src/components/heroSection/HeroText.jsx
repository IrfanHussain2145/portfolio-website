...
const HeroText = () => {
  return (
    <div className="flex flex-col gap-4 h-full justify-center md:text-left sm:text-center">
        ...
        className="lg:text-2xl sm:text-xl uppercase text-cyan "> Data Science & Consulting </motion.h2>
        ...
        className="text-lg mt-4 text-white"> Leveraging data to uncover insights and drive impactful business solutions. </motion.p>
    </div>
  )
}
